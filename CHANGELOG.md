...
- **SQL Injection защита** - жесткая проверка всех запросов
- **DML операции** - полностью заблокированы на уровне кода
- **Prompt Injection** - улучшенные инструкции в системном промпте
